...
let DeviceRepository = class DeviceRepository {
    ...
    async updateDevice(id, updateDeviceModel) {
        const device = await this.deviceRepository.findOne({ where: { id } });
        if (device) {
            const updatedDevice = Object.assign(Object.assign({}, device), updateDeviceModel);
...
DeviceRepository = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(device_entity_1.Devices)),
