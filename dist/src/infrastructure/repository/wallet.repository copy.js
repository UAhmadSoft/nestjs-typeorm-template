...
let WalletRepository = class WalletRepository {
    ...
    async getTokenPrice(symbol) {
        try {
            ...
            throw new common_1.BadRequestException(`Error getting token price: ${error}`);
        }
    }
    async getAccountTokenBalance() {
        try {
            ...
            throw new common_1.BadRequestException(`Error getting account token balance: ${error}`);
        }
    }
    async getAssetBalance(token) {
        try {
            ...
            throw new common_1.BadRequestException(`Error getting asset balance: ${error}`);
        }
    }
    async getFundingWallet() {
        try {
            ...
            throw new common_1.BadRequestException(`Error getting funding wallet: ${error}`);
        }
    }
    async getOrderBook(symbol) {
        try {
            ...
            throw new common_1.BadRequestException(`Error getting order book: ${error}`);
        }
    }
    async getTradeHistory(symbol) {
        try {
            ...
            throw new common_1.BadRequestException(`Error getting trade history: ${error}`);
        }
    }
    async getOrderHistory(symbol) {
        try {
            ...
            throw new common_1.BadRequestException(`Error getting order history: ${error}`);
        }
    }
    async depositHistory(coin) {
        try {
            ...
            throw new common_1.BadRequestException(`Error getting deposit history: ${error}`);
        }
    }
    async deposit(body) {
        const { symbol } = body;
        ...
        try {
            ...
            throw new common_1.BadRequestException(`Error depositing ${symbol}: ${error}`);
        }
    }
    async withdraw(body) {
        ...
        try {
            ...
            throw new common_1.BadRequestException(`Error withdrawing ${symbol}: ${error}`);
        }
    }
    async convert(body) {
        ...
        try {
            ...
            throw new common_1.BadRequestException(`Error converting ${symbol}: ${error}`);
        }
    }
...
//# sourceMappingURL=wallet.repository%20copy.js.map