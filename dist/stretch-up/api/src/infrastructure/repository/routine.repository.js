...
let RoutineRepository = class RoutineRepository {
    ...
    async createRoutine(routineModel) {
        return await this.routineRepository.save(routineModel);
    }
    async getRoutine(id) {
    ...
    async updateRoutine(id, updateRoutineModel) {
        ...
        if (routine) {
            const updatedRoutine = Object.assign(Object.assign({}, routine), updateRoutineModel);
            return this.routineRepository.save(updatedRoutine);
        }
        return;
    }
